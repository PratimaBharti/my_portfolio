...
const Social = () => {
    return (
        <div className="home__social">
            <a href="https://www.linkedin.com/in/pratimabharti/" className="home__social-icon" target="_blank"><i class="uil uil-linkedin"></i></a>
            <a href="https://github.com/PratimaBharti" className="home__social-icon" target="_blank"><i class="uil uil-github"></i></a>

            <a href="https://leetcode.com/pratima_vs/" className="home__social-icon" target="_blank"> 
            ...
            <a href="https://auth.geeksforgeeks.org/user/pratimabhartisittu" className="home__social-icon" target="_blank">
