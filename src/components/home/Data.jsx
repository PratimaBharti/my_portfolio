...
import CVV from "../../assets/pratima_resume.pdf";
...
const Data = () => {
    return (
        <div className="home__data">
            ...
            <p className="home__description">Greetings! As a student pursuing Master of Technology in Networks and Security,I'm excited to present my journey, accomplishments, and projects in my portfolio</p>

        
            <a download="" href={CVV} className="button button--flex">Download CV
                <svg
                class="button__icon"
                xmlns="http://www.w3.org/2000/svg"
                width="24"
