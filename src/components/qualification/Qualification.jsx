                    ...
                    >
                        ...
                        <div className="qualification__data">
                            ...
                            <div>
                                ...
                                <span className="qualification__subtitle">IIITKalyani,West Bengal</span>
                                <div className="qualification__calender">
                                    <i className="uil uil-calender-alt"></i>
                                    2016 - 2020
                                </div>
                        ...
                        <div className="qualification__data">
                            <div>
                                ...
                                <span className="qualification__subtitle">Central Hindu Girls School(K) BHU</span>
                                <div className="qualification__calender">
                                    <i className="uil uil-calender-alt"></i>
                                    2016
                                </div>
                        ...
                        <div className="qualification__data">
                            ...
                            <div>
                                ...
                                <span className="qualification__subtitle">DAV Public School,Khadia</span>
                                <div className="qualification__calender">
                                    <i className="uil uil-calender-alt"></i>
                                    2014
                                </div>
